...
#if UI_COLOR_ADD | UI_COLOR_SUB | UI_COLOR_SET |UI_COLOR_JAYADD |UI_COLOR_SETANDJAYADD
#define UI_COLOR
#endif
...
fixed4 ApplyColorEffect(fixed4 color, fixed4 factor)
{
	...
	//color.rgba += factor.rgba ;

	#elif UI_COLOR_JAYADD // Add
	color.rgba += factor.rgba ;

	#elif UI_COLOR_SETANDJAYADD // Add
	color.rgb = lerp(color.rgb, factor.rgb, factor.a);
...
//################################
// Apply color effect.
fixed4 ApplyColorEffect2(fixed4 color, fixed4 factor, fixed4 color2)
{
#ifdef UI_COLOR_SET // Set
	color.rgb = lerp(color.rgb, factor.rgb, factor.a);
