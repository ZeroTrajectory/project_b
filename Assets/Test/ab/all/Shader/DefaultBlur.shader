...
Shader "CustomUI/Default"
{
	Properties
	{
        ...
        _Contrast("对比度",Range(-3, 3)) = 0
        _Saturation("饱和度",Range(-3, 3)) = 0
        //--------------add------------------
	}
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			{
				return (inColor + (GetGray(inColor) -0.5 * step(0.01, inColor.a)) * _Contrast);
			}
...
//				//return color;
                ...
                computedColor = GetContrast(computedColor);
                computedColor = GetSaturation(computedColor);
